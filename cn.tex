...
\usepackage[paperwidth=210mm,paperheight=600mm,margin=20mm]{geometry}
...
\begin{content}
	\begin{position}
		...
		{}
		{蔚来公司}
		\item 为基于 seL4 的微内核设计底层软件（虚拟机/操作系统），以支持 AI 应用。
	\end{position}
...
我合计作为第一作者/共同第一作者（以*标记）发表\textbf{七篇CCF-A类论文}，其中三篇是安全领域的“四大”会议。
